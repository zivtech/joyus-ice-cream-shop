...
4. Preserve and link recovered planning artifacts. (Completed: recovered index and canonical mapping documented in `docs/planning/recovered/README.md`)
...
3. Add planned-vs-actual staffing variance model with transparent fallbacks. (Wave 1 baseline complete: expected-source attribution and fallback disclosure in Recent Staffing Analysis panel)
4. Add compliance scaffolding for youth/overtime/notice rules. (Wave 1 baseline complete: governed settings/compliance scaffold widgets with lineage and page wiring)
