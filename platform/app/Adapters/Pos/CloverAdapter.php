...
class CloverAdapter implements PosAdapter
{
     ...
     *
     * Clover POS API is not yet integrated.
     */
    public function importDailySales(Location $location, string $startDate, string $endDate): Collection
    {
        Log::info("Clover adapter: importDailySales not yet implemented for location {$location->code}");
    ...
    {
        Log::info("Clover adapter: importEmployees not yet implemented for location {$location->code}");
    ...
    {
        Log::info("Clover adapter: publishSchedule not yet implemented for location {$location->code}");
    ...
    {
        Log::info("Clover adapter: health check not yet available for location {$location->code}");
